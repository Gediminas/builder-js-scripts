...
function dependList($dep_data_path, $preserves, $type, $silent=0) // 1-remove list; 2-keep list
{
...
$dep_data_path = $1;
$preserves = $2;
$type = $3; // 1-remove list; 2-keep list
$silent = $4;
get_dependecy_lists($dep_data_path, $preserves, $type, $silent)
